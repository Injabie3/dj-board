...
#define DEVICE_ID_DMA_RX                XPAR_AXI_DMA_MIXER_ALTERED_DEVICE_ID
...
#define RX_TOMIX_BUFFER_BASE      		(DDR_BASE + 0x002C0000)
#define RX_MIXED_BUFFER_BASE      		(DDR_BASE + 0x00300000)
