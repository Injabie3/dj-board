...
void dataOut(int samplesToSend, volatile u32* toSendBuffer, int offset, bool circularBufferOnly);

void equalize();

void sendToMixer(volatile u64* toBuffer, volatile u32* recieveBuffer);
