...
#
# Generated by Vivado on Fri Apr 13 14:43:43 -0700 2018
...
#
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files audioMixing.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-22-ivana-milestone6FAIL/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd
}
...
# module references:
# audioMixing, beatDetector, beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  # Create instance: audioMixing_0, and set properties
  set block_name audioMixing
  set block_cell_name audioMixing_0
  if { [catch {set audioMixing_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $audioMixing_0 eq "" } {
  ...
  # Create instance: axi_dma_mixer_altered, and set properties
  set axi_dma_mixer_altered [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_mixer_altered ]
  set_property -dict [ list \
   CONFIG.c_include_mm2s {1} \
   CONFIG.c_include_s2mm {1} \
   CONFIG.c_include_sg {0} \
   CONFIG.c_sg_include_stscntrl_strm {0} \
 ] $axi_dma_mixer_altered
  ...
  # Create instance: sliceBeatDetector02Config, and set properties
  set sliceBeatDetector02Config [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sliceBeatDetector02Config ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {8} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {10} \
   CONFIG.DOUT_WIDTH {9} \
 ] $sliceBeatDetector02Config
  ...
  connect_bd_intf_net -intf_net audioMixing_0_M_dma [get_bd_intf_pins audioMixing_0/M_dma] [get_bd_intf_pins axi_dma_mixer_altered/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_mixer_altered_M_AXIS_MM2S [get_bd_intf_pins audioMixing_0/S_Rx] [get_bd_intf_pins axi_dma_mixer_altered/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_mixer_altered_M_AXI_MM2S [get_bd_intf_pins axi_dma_mixer_altered/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_mixer_altered_M_AXI_S2MM [get_bd_intf_pins axi_dma_mixer_altered/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_mixer_recorded_sounds_M_AXIS_MM2S [get_bd_intf_pins audioMixing_0/S_Rec] [get_bd_intf_pins axi_dma_mixer_recorded_sounds/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_mixer_recorded_sounds_M_AXI_MM2S [get_bd_intf_pins axi_dma_mixer_recorded_sounds/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S04_AXI]
  ...
  connect_bd_intf_net -intf_net beatDetector02_M_dma [get_bd_intf_pins axi_dma_fft/S_AXIS_S2MM] [get_bd_intf_pins beatDetector02/M_dma]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_dma_mixer_altered/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_dma_mixer_recorded_sounds/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M10_AXI [get_bd_intf_pins axi_gpio_play_interrupt/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M10_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o1 [get_bd_pins audioMixing_0/playInterrupt] [get_bd_pins axi_gpio_play_interrupt/gpio_io_o]
  connect_bd_net -net axi_gpio_beatDetector02_config_gpio2_io_o [get_bd_pins axi_gpio_beatDetector02_config/gpio2_io_o] [get_bd_pins sliceBeatDetector02Config/Din] [get_bd_pins sliceBeatDetector02Valid/Din]
  ...
  connect_bd_net -net beatDetector02_led [get_bd_ports LD2] [get_bd_ports LD3] [get_bd_pins beatDetector02/led]
  connect_bd_net -net beatDetector_0_led [get_bd_ports LD0] [get_bd_ports LD1] [get_bd_pins beatDetector01/led]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AudioInOut16_0/s00_axi_aclk] [get_bd_pins audioMixing_0/clk] [get_bd_pins axi_dma_fft/m_axi_mm2s_aclk] [get_bd_pins axi_dma_fft/m_axi_s2mm_aclk] [get_bd_pins axi_dma_fft/s_axi_lite_aclk] [get_bd_pins axi_dma_mixer_altered/m_axi_mm2s_aclk] [get_bd_pins axi_dma_mixer_altered/m_axi_s2mm_aclk] [get_bd_pins axi_dma_mixer_altered/s_axi_lite_aclk] [get_bd_pins axi_dma_mixer_recorded_sounds/m_axi_mm2s_aclk] [get_bd_pins axi_dma_mixer_recorded_sounds/s_axi_lite_aclk] [get_bd_pins axi_gpio_beatDetector01_config/s_axi_aclk] [get_bd_pins axi_gpio_beatDetector02_config/s_axi_aclk] [get_bd_pins axi_gpio_buttons/s_axi_aclk] [get_bd_pins axi_gpio_fft_config/s_axi_aclk] [get_bd_pins axi_gpio_middleC/s_axi_aclk] [get_bd_pins axi_gpio_play_interrupt/s_axi_aclk] [get_bd_pins axi_gpio_switches/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins beatDetector01/clk] [get_bd_pins beatDetector02/clk] [get_bd_pins complexMultiplier01/aclk] [get_bd_pins complexMultiplier02/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pushButtonDebouncer/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switchDebouncer/clk] [get_bd_pins xfft_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioInOut16_0/s00_axi_aresetn] [get_bd_pins audioMixing_0/reset] [get_bd_pins axi_dma_fft/axi_resetn] [get_bd_pins axi_dma_mixer_altered/axi_resetn] [get_bd_pins axi_dma_mixer_recorded_sounds/axi_resetn] [get_bd_pins axi_gpio_beatDetector01_config/s_axi_aresetn] [get_bd_pins axi_gpio_beatDetector02_config/s_axi_aresetn] [get_bd_pins axi_gpio_buttons/s_axi_aresetn] [get_bd_pins axi_gpio_fft_config/s_axi_aresetn] [get_bd_pins axi_gpio_middleC/s_axi_aresetn] [get_bd_pins axi_gpio_play_interrupt/s_axi_aresetn] [get_bd_pins axi_gpio_switches/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins beatDetector01/reset] [get_bd_pins beatDetector02/reset] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
  connect_bd_net -net sliceBeatDetector02Config_Dout [get_bd_pins concatBeatDetector02Config/In1] [get_bd_pins sliceBeatDetector02Config/Dout]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins beatDetector01/isFft] [get_bd_pins beatDetector02/isFft] [get_bd_pins sliceFftForward/Dout]
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_mixer_altered/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_mixer_altered/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_mixer_altered/S_AXI_LITE/Reg] SEG_axi_dma_mixer_altered_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40420000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_mixer_recorded_sounds/S_AXI_LITE/Reg] SEG_axi_dma_mixer_recorded_sounds_Reg
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41260000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_play_interrupt/S_AXI/Reg] SEG_axi_gpio_0_Reg2
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_fft_config/S_AXI/Reg] SEG_axi_gpio_fft_config_Reg
