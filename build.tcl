...
#
# Generated by Vivado on Mon Apr 09 18:50:05 -0700 2018
...
#
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-14-luiMilestone05/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
...
# beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  # Create instance: beatDetector_0, and set properties
  set block_name beatDetector
  set block_cell_name beatDetector_0
  if { [catch {set beatDetector_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $beatDetector_0 eq "" } {
  ...
  # Create instance: sliceComplexResult, and set properties
  set sliceComplexResult [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sliceComplexResult ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {64} \
  ...
  connect_bd_net -net axi_dma_fft_s_axis_s2mm_tready [get_bd_pins axi_dma_fft/s_axis_s2mm_tready] [get_bd_pins beatDetector_0/M_tReady]
  ...
  connect_bd_net -net beatDetector_0_M_tData [get_bd_pins axi_dma_fft/s_axis_s2mm_tdata] [get_bd_pins beatDetector_0/M_tData]
  connect_bd_net -net beatDetector_0_M_tLast [get_bd_pins axi_dma_fft/s_axis_s2mm_tlast] [get_bd_pins beatDetector_0/M_tLast]
  connect_bd_net -net beatDetector_0_M_tValid [get_bd_pins axi_dma_fft/s_axis_s2mm_tvalid] [get_bd_pins beatDetector_0/M_tValid]
  connect_bd_net -net beatDetector_0_S_tReady [get_bd_pins beatDetector_0/S_tReady] [get_bd_pins xfft_0/m_axis_data_tready]
  connect_bd_net -net beatDetector_0_complexATDataIn [get_bd_pins beatDetector_0/complexATDataIn] [get_bd_pins cmpy_0/s_axis_a_tdata] [get_bd_pins system_ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets beatDetector_0_complexATDataIn]
  connect_bd_net -net beatDetector_0_complexBTDataIn [get_bd_pins beatDetector_0/complexBTDataIn] [get_bd_pins cmpy_0/s_axis_b_tdata] [get_bd_pins system_ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets beatDetector_0_complexBTDataIn]
  connect_bd_net -net beatDetector_0_complexTReadyOut [get_bd_pins beatDetector_0/complexTReadyOut] [get_bd_pins cmpy_0/m_axis_dout_tready]
  connect_bd_net -net beatDetector_0_complexTValidIn [get_bd_pins beatDetector_0/complexTValidIn] [get_bd_pins cmpy_0/s_axis_a_tvalid] [get_bd_pins cmpy_0/s_axis_b_tvalid]
  connect_bd_net -net beatDetector_0_led [get_bd_ports led_0] [get_bd_pins beatDetector_0/led]
  connect_bd_net -net btns_5bits_1 [get_bd_ports btns_5bits] [get_bd_pins pushButtonDebouncer/myinput]
  connect_bd_net -net cmpy_0_m_axis_dout_tdata [get_bd_pins cmpy_0/m_axis_dout_tdata] [get_bd_pins sliceComplexResult/Din] [get_bd_pins system_ila_0/probe2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets cmpy_0_m_axis_dout_tdata]
  connect_bd_net -net cmpy_0_m_axis_dout_tvalid [get_bd_pins beatDetector_0/complexTValidOut] [get_bd_pins cmpy_0/m_axis_dout_tvalid]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioInOut16_0/s00_axi_aresetn] [get_bd_pins axi_dma_fft/axi_resetn] [get_bd_pins axi_gpio_buttons/s_axi_aresetn] [get_bd_pins axi_gpio_fft_config/s_axi_aresetn] [get_bd_pins axi_gpio_middleC/s_axi_aresetn] [get_bd_pins axi_gpio_switches/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins beatDetector_0/reset] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
  ...
  connect_bd_net -net xfft_0_m_axis_data_tdata [get_bd_pins beatDetector_0/S_tData] [get_bd_pins xfft_0/m_axis_data_tdata]
  connect_bd_net -net xfft_0_m_axis_data_tlast [get_bd_pins beatDetector_0/S_tLast] [get_bd_pins xfft_0/m_axis_data_tlast]
  connect_bd_net -net xfft_0_m_axis_data_tvalid [get_bd_pins beatDetector_0/S_tValid] [get_bd_pins xfft_0/m_axis_data_tvalid]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins beatDetector_0/complexTDataOut] [get_bd_pins sliceComplexResult/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins beatDetector_0/isFft] [get_bd_pins sliceFftForward/Dout]
