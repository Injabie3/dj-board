...
#
# Generated by Vivado on Sun Apr 08 12:15:43 -0700 2018
...
#
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files debouncer5.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-02-19-luiMilestone02Integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd
}
...
# debouncer5, myNote
  ...
  # Create instance: debouncer5_0, and set properties
  set block_name debouncer5
  set block_cell_name debouncer5_0
  if { [catch {set debouncer5_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $debouncer5_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: myNote_0, and set properties
  set block_name myNote
  set block_cell_name myNote_0
  if { [catch {set myNote_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $myNote_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_intf_net -intf_net axi_gpio_SW_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins axi_gpio_switches/GPIO]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_middleC/gpio2_io_o] [get_bd_pins myNote_0/clk]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_middleC/gpio_io_o] [get_bd_pins myNote_0/increment]
  connect_bd_net -net axi_gpio_buttons_ip2intc_irpt [get_bd_pins axi_gpio_buttons/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_fft_config_gpio2_io_o [get_bd_pins axi_gpio_fft_config/gpio2_io_o] [get_bd_pins xfft_0/s_axis_config_tvalid]
  connect_bd_net -net axi_gpio_fft_config_gpio_io_o [get_bd_pins axi_gpio_fft_config/gpio_io_o] [get_bd_pins xfft_0/s_axis_config_tdata]
  connect_bd_net -net axi_gpio_switches_ip2intc_irpt [get_bd_pins axi_gpio_switches/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net debouncer5_0_debounced [get_bd_pins axi_gpio_buttons/gpio_io_i] [get_bd_pins debouncer5_0/debounced]
  connect_bd_net -net myNote_0_output [get_bd_pins axi_gpio_middleC/gpio_io_i] [get_bd_pins myNote_0/output]
  connect_bd_net -net myinput_0_1 [get_bd_ports btns_5bits] [get_bd_pins debouncer5_0/myinput]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AudioInOut16_0/s00_axi_aclk] [get_bd_pins axi_dma_fft/m_axi_mm2s_aclk] [get_bd_pins axi_dma_fft/m_axi_s2mm_aclk] [get_bd_pins axi_dma_fft/s_axi_lite_aclk] [get_bd_pins axi_gpio_buttons/s_axi_aclk] [get_bd_pins axi_gpio_fft_config/s_axi_aclk] [get_bd_pins axi_gpio_middleC/s_axi_aclk] [get_bd_pins axi_gpio_switches/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins debouncer5_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins xfft_0/aclk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins myNote_0/amplHigh] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins myNote_0/amplLow] [get_bd_pins xlconstant_1/dout]
