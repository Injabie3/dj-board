...
#
# Generated by Vivado on Wed Apr 25 18:43:00 -0700 2018
...
#
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "D:/github/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files audioMixing.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 D:/github/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
...
# audioMixing, beatDetector, beatDetector, beatDetector, beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  set JC1_N [ create_bd_port -dir O JC1_N ]
  set JC1_P [ create_bd_port -dir O JC1_P ]
  set JC2_N [ create_bd_port -dir O JC2_N ]
  set JC2_P [ create_bd_port -dir O JC2_P ]
  set JC3_N [ create_bd_port -dir O JC3_N ]
  set JC3_P [ create_bd_port -dir O JC3_P ]
  set JC4_N [ create_bd_port -dir O JC4_N ]
  set JC4_P [ create_bd_port -dir O JC4_P ]
  ...
  connect_bd_net -net axi_gpio_fft_config_gpio_io_o [get_bd_pins axi_gpio_fft_config/gpio_io_o] [get_bd_pins sliceFftForward/Din] [get_bd_pins xfft_0/s_axis_config_tdata]
  ...
  connect_bd_net -net beatDetector01_led [get_bd_ports JC2_N] [get_bd_ports JC3_P] [get_bd_ports LD3] [get_bd_ports LD4] [get_bd_pins beatDetector01/led]
  connect_bd_net -net beatDetector02_led [get_bd_ports JC2_P] [get_bd_ports JC3_N] [get_bd_ports LD2] [get_bd_ports LD5] [get_bd_pins beatDetector02/led]
  connect_bd_net -net beatDetector03_led [get_bd_ports JC1_N] [get_bd_ports JC4_P] [get_bd_ports LD1] [get_bd_ports LD6] [get_bd_pins beatDetector03/led]
  connect_bd_net -net beatDetector04_led [get_bd_ports JC1_P] [get_bd_ports JC4_N] [get_bd_ports LD0] [get_bd_ports LD7] [get_bd_pins beatDetector04/led]
