...
#
# Generated by Vivado on Thu Apr 12 20:46:05 -0700 2018
...
#
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-15-luiMilestone05Updated/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
...
# module references:
# beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  # Create instance: axi_gpio_beatDetector_config, and set properties
  set axi_gpio_beatDetector_config [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_beatDetector_config ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
   CONFIG.C_ALL_OUTPUTS_2 {1} \
   CONFIG.C_GPIO2_WIDTH {10} \
   CONFIG.C_IS_DUAL {1} \
 ] $axi_gpio_beatDetector_config
  ...
  # Create instance: beatDetector, and set properties
  set block_name beatDetector
  set block_cell_name beatDetector
  if { [catch {set beatDetector [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $beatDetector eq "" } {
  ...
  # Create instance: complexMultiplier, and set properties
  set complexMultiplier [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 complexMultiplier ]
  set_property -dict [ list \
  ...
  # Create instance: concatBeatDetectorConfig, and set properties
  set concatBeatDetectorConfig [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concatBeatDetectorConfig ]
  ...
  # Create instance: sliceBeatDetectorBin, and set properties
  set sliceBeatDetectorBin [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sliceBeatDetectorBin ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {8} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {10} \
   CONFIG.DOUT_WIDTH {9} \
 ] $sliceBeatDetectorBin

  # Create instance: sliceBeatDetectorValid, and set properties
  set sliceBeatDetectorValid [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 sliceBeatDetectorValid ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {9} \
   CONFIG.DIN_TO {9} \
   CONFIG.DIN_WIDTH {10} \
   CONFIG.DOUT_WIDTH {1} \
 ] $sliceBeatDetectorValid
  ...
  connect_bd_intf_net -intf_net beatDetector_0_M_complexA [get_bd_intf_pins beatDetector/M_complexA] [get_bd_intf_pins complexMultiplier/S_AXIS_A]
  connect_bd_intf_net -intf_net beatDetector_0_M_complexB [get_bd_intf_pins beatDetector/M_complexB] [get_bd_intf_pins complexMultiplier/S_AXIS_B]
  connect_bd_intf_net -intf_net beatDetector_0_M_dma [get_bd_intf_pins axi_dma_fft/S_AXIS_S2MM] [get_bd_intf_pins beatDetector/M_dma]
  connect_bd_intf_net -intf_net cmpy_0_M_AXIS_DOUT [get_bd_intf_pins beatDetector/S_complexO] [get_bd_intf_pins complexMultiplier/M_AXIS_DOUT]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M06_AXI [get_bd_intf_pins axi_gpio_beatDetector_config/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net xfft_0_M_AXIS_DATA [get_bd_intf_pins beatDetector/S_fft] [get_bd_intf_pins xfft_0/M_AXIS_DATA]
  ...
  connect_bd_net -net beatDetector_0_led [get_bd_ports led_0] [get_bd_pins beatDetector/led]
  connect_bd_net -net btns_5bits_1 [get_bd_ports btns_5bits] [get_bd_pins pushButtonDebouncer/myinput]
  connect_bd_net -net concatBeatDetectorConfig_dout [get_bd_pins beatDetector/S_config_tData] [get_bd_pins concatBeatDetectorConfig/dout]
  ...
  connect_bd_net -net gpioBeatDetectorConfig_gpio2_io_o [get_bd_pins axi_gpio_beatDetector_config/gpio2_io_o] [get_bd_pins sliceBeatDetectorBin/Din] [get_bd_pins sliceBeatDetectorValid/Din]
  connect_bd_net -net gpioBeatDetectorConfig_gpio_io_o [get_bd_pins axi_gpio_beatDetector_config/gpio_io_o] [get_bd_pins concatBeatDetectorConfig/In0]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioInOut16_0/s00_axi_aresetn] [get_bd_pins axi_dma_fft/axi_resetn] [get_bd_pins axi_gpio_beatDetector_config/s_axi_aresetn] [get_bd_pins axi_gpio_buttons/s_axi_aresetn] [get_bd_pins axi_gpio_fft_config/s_axi_aresetn] [get_bd_pins axi_gpio_middleC/s_axi_aresetn] [get_bd_pins axi_gpio_switches/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins beatDetector/reset] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
  connect_bd_net -net sliceBeatDetectorBin_Dout [get_bd_pins concatBeatDetectorConfig/In1] [get_bd_pins sliceBeatDetectorBin/Dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins beatDetector/S_config_tValid] [get_bd_pins sliceBeatDetectorValid/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins beatDetector/isFft] [get_bd_pins sliceFftForward/Dout]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x41240000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_beatDetector_config/S_AXI/Reg] SEG_gpioBeatDetectorConfig_Reg
