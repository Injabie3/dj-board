...
#
# Generated by Vivado on Fri Apr 13 23:21:14 -0700 2018
...
#
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-23-luiMilestone06MoreProgress/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
...
# beatDetector, beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_fft/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_fft/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
