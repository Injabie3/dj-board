...
#
# Generated by Vivado on Sat Apr 14 02:34:07 -0700 2018
...
#
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files audioMixing.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-03-30-ivanaUpdatedHWBlock-integratedwithEqualizing/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd
}
...
# audioMixing, beatDetector, beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  connect_bd_intf_net -intf_net audioMixing_0_M_dma [get_bd_intf_pins audioMixing_0/M_dma] [get_bd_intf_pins axi_dma_mixer/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins audioMixing_0/S_Rx] [get_bd_intf_pins axi_dma_mixer/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_mixer/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_mixer/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S03_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_dma_mixer/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AudioInOut16_0/s00_axi_aclk] [get_bd_pins audioMixing_0/clk] [get_bd_pins axi_dma_fft/m_axi_mm2s_aclk] [get_bd_pins axi_dma_fft/m_axi_s2mm_aclk] [get_bd_pins axi_dma_fft/s_axi_lite_aclk] [get_bd_pins axi_dma_mixer/m_axi_mm2s_aclk] [get_bd_pins axi_dma_mixer/m_axi_s2mm_aclk] [get_bd_pins axi_dma_mixer/s_axi_lite_aclk] [get_bd_pins axi_gpio_beatDetector01_config/s_axi_aclk] [get_bd_pins axi_gpio_beatDetector02_config/s_axi_aclk] [get_bd_pins axi_gpio_buttons/s_axi_aclk] [get_bd_pins axi_gpio_fft_config/s_axi_aclk] [get_bd_pins axi_gpio_middleC/s_axi_aclk] [get_bd_pins axi_gpio_switches/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins beatDetector01/clk] [get_bd_pins beatDetector02/clk] [get_bd_pins complexMultiplier01/aclk] [get_bd_pins complexMultiplier02/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pushButtonDebouncer/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins switchDebouncer/clk] [get_bd_pins xfft_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AudioInOut16_0/s00_axi_aresetn] [get_bd_pins audioMixing_0/reset] [get_bd_pins axi_dma_fft/axi_resetn] [get_bd_pins axi_dma_mixer/axi_resetn] [get_bd_pins axi_gpio_beatDetector01_config/s_axi_aresetn] [get_bd_pins axi_gpio_beatDetector02_config/s_axi_aresetn] [get_bd_pins axi_gpio_buttons/s_axi_aresetn] [get_bd_pins axi_gpio_fft_config/s_axi_aresetn] [get_bd_pins axi_gpio_middleC/s_axi_aresetn] [get_bd_pins axi_gpio_switches/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins beatDetector01/reset] [get_bd_pins beatDetector02/reset] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins xfft_0/aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_mixer/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
