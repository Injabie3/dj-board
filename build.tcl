...
#
# Generated by Vivado on Sat Apr 14 13:43:27 -0700 2018
...
#
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/bd/audioTest/hdl/audioTest_wrapper.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/debouncer5.vhd"
#    "B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/constrs_1/imports/ZedBoardAudio-master/constraintAudio.xdc"
#
...
if { [get_files myNote.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/imports/myNote.vhd
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
if { [get_files debouncer.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/debouncer.vhd
}
if { [get_files dflipflop.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/dflipflop.vhd
}
if { [get_files genericDebouncer.vhdl] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/genericDebouncer.vhdl
}
if { [get_files counter.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/imports/counter.vhd
}
...
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files beatDetector.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/beatDetector.vhd
}
if { [get_files audioMixing.vhd] == "" } {
  import_files -quiet -fileset sources_1 B:/ENSC452-git/2018-04-02-ivanaHWblock-ryanVGA-integrated/audioOutAXI/audioOutAXI.srcs/sources_1/new/audioMixing.vhd
}
...
# audioMixing, beatDetector, beatDetector, myNote, genericDebouncer, genericDebouncer
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o1 [get_bd_pins audioMixer/playInterrupt] [get_bd_pins axi_gpio_play_interrupt/gpio_io_o] [get_bd_pins system_ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets axi_gpio_0_gpio_io_o1]
  ...
  connect_bd_net -net beatDetector02_led [get_bd_ports LD2] [get_bd_ports LD3] [get_bd_ports LD4] [get_bd_ports LD5] [get_bd_pins beatDetector02/led]
  connect_bd_net -net beatDetector_0_led [get_bd_ports LD0] [get_bd_ports LD1] [get_bd_ports LD6] [get_bd_ports LD7] [get_bd_pins beatDetector01/led]
